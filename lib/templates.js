...
exports.emailSignup = function (verificationCode) {
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr>
                                    <td class="bg_dark-otp email-section" style="text-align:center;">
                                        <div class="heading-section heading-section-white">
                                            <h3 style="margin-bottom:2px; font-family: 'Montserrat', sans-serif;text-decoration: underline"
                                                ;>
                                                Please Use this Verification Code to Complete your Signup</h3>
                                            <h2 style="margin-bottom:0px" ;>${verificationCode}</h2>
                                        </div>
                                    </td>
                                </tr>
